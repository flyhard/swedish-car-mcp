...
install_file "$SCRIPT_DIR/lib/common.sh" "$LIB_DIR/common.sh"
install_file "$SCRIPT_DIR/bilmarknad-mcp" "$BIN_DIR/bilmarknad-mcp"
install_file "$SCRIPT_DIR/aviloo-mcp" "$BIN_DIR/aviloo-mcp"
